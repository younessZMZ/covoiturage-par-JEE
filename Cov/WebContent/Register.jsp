            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form action="controleur" method="post">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">Male
                                            <input type="radio" checked="checked" name="sexe" value="M">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="passwd">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit" value="Inscription" name="action">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
